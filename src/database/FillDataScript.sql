...
delete from ordermodels;
delete from validmaterials;
delete from customordermodels;
delete from users;
...
call registrarModelo('model6', 'Vox hat', 'https://cdn.thingiverse.com/assets/cb/3c/26/7e/54/large_display_7675b91a-d933-479b-8cb2-4b9b0b31b4af.png', 'tv_hat.stl', 11.99);
